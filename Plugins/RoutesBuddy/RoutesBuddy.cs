...
namespace RoutesBuddy
{
    ...
    {
        public override string Name { get { return "RoutesBuddy2"; } }
        public override string Author { get { return "Highvoltz/BadWolf)"; } }
        ...
        public override void Initialize()
        {
            MySettings = new RoutesBuddySettings
                (Path.Combine(Application.StartupPath, string.Format(@"Settings\{0}\{0}.xml", Name)));
            if (string.IsNullOrEmpty(MySettings.LastFolder))
                MySettings.LastFolder = System.Environment.CurrentDirectory;
            Gui = new MainForm();
        }
