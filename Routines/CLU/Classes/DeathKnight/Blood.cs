            ...
            get {
                return new PrioritySelector(
                        ...
                        new Decorator(
                            ...
                            new PrioritySelector(
                               Spell.CastSelfSpell("Death Pact",              ret => Me.HealthPercent < CLUSettings.Instance.DeathKnight.BloodPetSacrificePercent && Me.Minions.FirstOrDefault(q => q.CreatureType == WoWCreatureType.Undead || q.CreatureType == WoWCreatureType.Totem) != null && Spell.SpellOnCooldown("Raise Dead") && CLUSettings.Instance.DeathKnight.BloodUsePetSacrifice, "Death Pact"),
                               ...
                               Spell.CastSpell("Death Coil", ret => Me,       ret => Me.HealthPercent < CLUSettings.Instance.DeathKnight.DeathCoilHealPercent && Buff.PlayerHasBuff("Lichborne"), "Death Coil Heal"),
                               ...
                               Spell.CastSelfSpell("Empower Rune Weapon", ret => Me.CurrentTarget != null && CLUSettings.Instance.DeathKnight.UseEmpowerRuneWeapon && Unit.UseCooldowns() && StyxWoW.Me.FrostRuneCount < 1 && StyxWoW.Me.UnholyRuneCount < 2 && StyxWoW.Me.DeathRuneCount < 1 && !Buff.UnitHasHasteBuff(Me), "Empower Rune Weapon"),
