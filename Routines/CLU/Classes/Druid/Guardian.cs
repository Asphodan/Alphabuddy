            ...
            get
            {
                return new PrioritySelector(
                    // Cooldowns
                           ...
                           Spell.CastSpell("Thrash", ret => Buff.TargetDebuffTimeLeft("Weakened Blows").TotalSeconds < 2 || Buff.TargetDebuffTimeLeft("Thrash").TotalSeconds < 4 || Unit.EnemyMeleeUnits.Count() > 2, "Thrash (Bear)"),
