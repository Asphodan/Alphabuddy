...
// $HeadURL: https://subversion.assembla.com/svn/singular_v3/trunk/Singular/GUI/ConfigurationForm.cs $
...
namespace Singular.GUI
{
    public partial class ConfigurationForm : Form
    {
        ...
        {
            lblVersion.Text = string.Format("v{0}", Assembly.GetExecutingAssembly().GetName().Version) + " [$Revision: 864 $]";
